    ...
    <div className="p-8 bg-gradient-to-br from-gray-50 to-green-50/20 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        {stats.map((stat, index) => {
          ...
          return (
            <Card key={index} className="p-6 border-0 shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden group">
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {monthlyData.map((data) => (
              <div 
                key={data.month} 
                className={`border-2 rounded-2xl p-5 hover:shadow-lg transition-all duration-200 relative overflow-hidden group ${
                  data.status === 'completed' ? 'border-green-200 bg-gradient-to-br from-green-50/50 to-emerald-50/50' :
                  data.status === 'partial' ? 'border-orange-200 bg-gradient-to-br from-orange-50/50 to-amber-50/50' :
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <div className={`text-2xl mb-1 ${
                    data.status === 'completed' ? 'bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent' :
                    data.status === 'partial' ? 'bg-gradient-to-r from-orange-600 to-amber-600 bg-clip-text text-transparent' :
                    'text-gray-400'
                  }`}>
                    {data.overall}%
                  </div>
