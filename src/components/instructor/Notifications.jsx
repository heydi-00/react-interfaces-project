...
import { Bell, AlertCircle, CheckCircle, Info, Calendar, Trash2, CheckCheck, RotateCcw, Inbox } from "lucide-react";
...
const initialNotifications = [
  {
    ...
    message: "El informe de Noviembre 2024 debe ser entregado antes del 28 de este mes",
    date: "2024-11-05",
    read: false,
    icon: AlertCircle,
  ...
  },
  {
    ...
    message: "Tu informe GC de Octubre 2024 ha sido aprobado por el coordinador",
    date: "2024-11-04",
    read: false,
    icon: CheckCircle,
  ...
  },
  {
    id: 3,
    type: "info",
    title: "Disponibilidad de plataforma",
    message: "La plataforma estará habilitada del 1 al 28 de Noviembre para subir informes",
    date: "2024-11-01",
    read: true,
    icon: Calendar,
  ...
  },
  {
    ...
    message: "Has mantenido un excelente nivel de cumplimiento del 92% durante este trimestre",
    date: "2024-10-31",
    read: true,
    icon: CheckCircle,
    gradient: "from-green-500 to-emerald-600",
  ...
  },
  {
    ...
    message: "Reunión de coordinación programada para el 10 de Noviembre a las 10:00 AM",
    date: "2024-10-28",
    read: true,
    icon: Info,
