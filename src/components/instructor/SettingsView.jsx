...
import { User, Bell, Lock, Globe, Palette, Shield, Zap, HelpCircle, Sparkles } from 'lucide-react';
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input id="name" defaultValue={userName} className="mt-2 border-2 focus:border-[#39A900] transition-colors" />
                </div>
                <div>
                  <Label htmlFor="email">Correo electrónico</Label>
                  <Input id="email" type="email" defaultValue="instructor@sena.edu.co" className="mt-2 border-2 focus:border-[#39A900] transition-colors" />
                </div>
                <div>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input id="current-password" type="password" className="mt-2 border-2 focus:border-pink-500 transition-colors" />
                </div>
                <div>
                  <Label htmlFor="new-password">Nueva contraseña</Label>
                  <Input id="new-password" type="password" className="mt-2 border-2 focus:border-pink-500 transition-colors" />
                </div>
                <div>
                  <Label htmlFor="confirm-password">Confirmar nueva contraseña</Label>
                  <Input id="confirm-password" type="password" className="mt-2 border-2 focus:border-pink-500 transition-colors" />
                </div>
                <Button variant="outline" className="border-2 border-pink-500 text-pink-600 hover:bg-pink-50">
                  Cambiar Contraseña
                </Button>
              </div>
            </div>
