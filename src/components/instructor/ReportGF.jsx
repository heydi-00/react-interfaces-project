    ...
    <div className="p-8">
      ...
      <Card className="p-6 mb-6">
        ...
        <div className="space-y-4">
          {documents.map(doc => (
            <div key={doc.id} className="border border-gray-200 rounded-lg p-4 hover:border-[#39A900] transition-colors">
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className="text-[#39A900]">{doc.name}</h3>
                    {doc.required ? (
                      <span className="px-2 py-0.5 bg-red-100 text-red-700 text-xs rounded-full">Obligatorio</span>
                    ) : (
              ...
              {uploadedFiles[doc.id]?.length > 0 && (
                <div className="mt-2 flex items-center gap-2 text-sm text-[#39A900]">
                  <FileText size={16} />
