...
import { FileText, AlertCircle, CheckCircle, Clock, TrendingUp, Award, Target, ArrowUp } from 'lucide-react';
    ...
    <div className="p-8 bg-gradient-to-br from-gray-50 to-green-50/20 min-h-screen">
      ...
      <Card className="p-8 mb-8 border-0 shadow-lg">
        <div className="flex items-center justify-between mb-6">
          ...
          <Button className="bg-gradient-to-r from-[#39A900] to-green-600 hover:from-green-700 hover:to-green-700 shadow-lg shadow-green-200 rounded-xl h-11">
