...
export default function PlanillasView({ planillas, setPlanillas }) {
  ...
  return (
    <div className="p-8">
      ...
      {/* Form panel */}
      {showForm && (
        <Card className="p-6 mb-8 border-2 border-[#39A900]/30 bg-green-50/30">
      ...
      {planillas.length > 0 && (
        <div className="grid gap-4">
          {planillas.map(p => (
            <Card key={p.id} className="p-5 flex items-start gap-4 hover:shadow-md transition-shadow">
