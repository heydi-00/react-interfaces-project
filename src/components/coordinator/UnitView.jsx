...
import { FileText, Users, AlertCircle, CheckCircle, Clock, TrendingUp, Award, Sparkles } from "lucide-react";
export default function UnitView({ userName, onNavigate }) {
  ...
  return <div className="p-8 bg-gradient-to-br from-green-50 to-emerald-50/20 min-h-screen">
    ...
    key={alert.id}
    className={`p-4 rounded-xl border-2 ${alert.type === "urgent" ? "border-red-300 bg-gradient-to-r from-red-50 to-pink-50" : "border-orange-300 bg-gradient-to-r from-orange-50 to-amber-50"}`}
  >
  ...
  />
    ...
    className="w-full mt-6 bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 shadow-lg rounded-xl h-10 text-white"
  >
    ...
    className="bg-gradient-to-r from-[#39A900] to-green-600 hover:from-[#2d8400] hover:to-green-700 shadow-lg shadow-green-200 rounded-xl h-11 text-white"
  >
              Ver Todos
            </Button>
          </div>
          ...
          <div className="space-y-3">
            {pendingReports.map((report) => <div
    key={report.id}
    className={`p-5 rounded-2xl border-2 transition-all duration-200 ${report.urgent ? "border-red-300 bg-gradient-to-r from-red-50 to-pink-50 shadow-md" : "border-gray-100 bg-gradient-to-r from-gray-50 to-gray-50/50 hover:shadow-md"}`}
  >
                <div className="flex items-center justify-between">
                  ...
                  {report.urgent && <div className="px-4 py-2 bg-gradient-to-r from-red-500 to-pink-600 text-white rounded-xl text-sm font-medium shadow-lg">
                      Urgente
                    </div>}
                </div>
              </div>)}
  ...
  />
          ...
          <Button
    onClick={() => onNavigate?.("report-management")}
    className="w-full mt-8 bg-gradient-to-r from-[#39A900] to-green-600 hover:from-[#2d8400] hover:to-green-700 shadow-lg shadow-green-200 rounded-xl h-11 text-white"
  >
