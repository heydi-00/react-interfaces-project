            ...
            {monthlyData.map((data) => (
              <div
                ...
                className={`p-5 rounded-xl border-2 ${
                  data.status === 'current'
                    ? 'border-[#39A900] bg-gradient-to-r from-green-50 to-emerald-50'
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                        data.status === 'current'
                          ? 'bg-gradient-to-br from-[#39A900] to-green-600 text-white shadow-lg'
                    ...
                    <div>
                      ...
                      {data.status === 'current' && (
                        <div className="text-xs text-[#39A900] font-medium">Mes actual</div>
                      )}
                    </div>
                  </div>
                  <div
                    className={`text-2xl font-bold ${
                      data.status === 'current'
                        ? 'bg-gradient-to-r from-[#39A900] to-green-600 bg-clip-text text-transparent'
                        : 'text-gray-700'
                    }`}
                  >
                    {data.compliance}%
