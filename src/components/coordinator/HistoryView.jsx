...
import { History, FileText, CheckCircle, XCircle, Clock, Search, Filter, Download } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex gap-3">
            <Button
              ...
              className={
                filterStatus === 'all'
                  ? 'bg-gradient-to-r from-[#39A900] to-green-600 text-white h-12 rounded-xl'
                  : 'h-12 rounded-xl'
              }
            >
              Todos
            ...
            <Button
              ...
              className={
                filterStatus === 'approved'
                  ? 'bg-gradient-to-r from-green-500 to-emerald-600 text-white h-12 rounded-xl'
                  : 'h-12 rounded-xl'
              }
            >
              Aprobados
            ...
            <Button
              ...
              className={
                filterStatus === 'rejected'
                  ? 'bg-gradient-to-r from-red-500 to-pink-600 text-white h-12 rounded-xl'
                  : 'h-12 rounded-xl'
              }
            >
              Rechazados
