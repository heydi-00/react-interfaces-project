...
export default function SettingsView({ userName, userRole }) {
      ...
      <div className="mb-8 bg-gradient-to-r from-[#39A900] via-green-600 to-emerald-600 rounded-3xl p-8 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-green-100 text-lg">
            Personaliza tu experiencia en el sistema SITMI
          </p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                id="email"
                type="email"
                defaultValue={`${userName.toLowerCase().replace(' ', '.')}@sena.edu.co`}
                className="mt-2 h-11 border-gray-200 rounded-xl"
              />
            </div>
            <div>
